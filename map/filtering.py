...
df = pd.read_csv("./map/static/data/중구.csv", encoding='cp949')
print(df.count())
...
keywords = ["광희동","남학동","묵정동","방산동","산림동", "수표동", "신당동", "쌍림동",
           ...
           "삼일대로6길2","삼일대로6길5","삼일대로6길11","삼일대로6길13","삼일대로6길14","삼일대로6길15",
           "삼일대로6길16","삼일대로6길17","삼일대로6길20", "삼일대로8길5","삼일대로8길9","삼일대로8길12",
           "삼일대로8길13","삼일대로8길14","삼일대로8길15","삼일대로8길16","삼일대로8길17","삼일대로8길19",
           "삼일대로8길20","삼일대로8길20-1", "수표로1", "수표로3", "수표로3-3", "수표로3-5","수표로3-6",
...
df.to_excel("./map/static/data/joongGoo.xlsx",sheet_name="Sheet1")